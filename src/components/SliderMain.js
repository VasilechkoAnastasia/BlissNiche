...
const SliderMain = () => {
  ...
  useEffect(() => {
    ...
    // Проверяем, что слайдер существует, прежде чем работать с ним
    if (sliderBody) {
      ...
      // Добавление обработчиков событий только если элементы существуют
    ...
    <div className="slider__container js-slider-element" ref={sliderRef}>
      ...
      <div className="slider__wrapper">
        <div className="slider js-slider-body" ref={sliderBodyRef}>
          {[...Array(10)].map((_, i) => (
            <div className="slider__item js-slide" key={i}>
